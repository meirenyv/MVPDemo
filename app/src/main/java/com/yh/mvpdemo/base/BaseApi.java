...
import com.yh.mvpdemo.utils.ApplicationUtils;
import com.yh.mvpdemo.utils.NetWorkUtil;
...
public class BaseApi {
    ...
    public Retrofit getSimpleRetrofit(String baseUrl) {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(baseUrl)
                .addConverterFactory(ScalarsConverterFactory.create())//将请求结果转换为基本类型一般为String
    ...
    public Retrofit getRetrofit(String baseUrl) {
        ...
        //缓存
        File cacheFile = new File(ApplicationUtils.getContext().getCacheDir(), "cache");
    ...
    private final Interceptor mRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetWorkUtil.isNetConnected(ApplicationUtils.getContext())) {//断网时配置缓存策略
...
//                        .cacheControl(CacheControl.FORCE_CACHE)
            ...
            if (NetWorkUtil.isNetConnected(ApplicationUtils.getContext())) {//在线缓存
//                KLog.e("在线缓存2分钟");
